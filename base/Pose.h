...
namespace COMMON_LYJ
{
    ...
    public:
            ...
            const Eigen::Vector3d& _c2, const Eigen::Vector3d& _n2)
        {
            ...
            Eigen::Matrix3d R = Rodrigues2RotMatrix(axis, angle);
        ...
        Eigen::Vector3f operator*(const Eigen::Vector3f& _P) const
        {
            return R.cast<float>() * _P + t.cast<float>();
        }
        Eigen::Vector3f transformNormal(const Eigen::Vector3f& _n) const
        {
            return R.cast<float>() * _n;
        }
